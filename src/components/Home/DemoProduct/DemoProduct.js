...
const DemoProduct = () => {
  return (
    <div className="2xl:py-[100px] py-[50px] bg-black">
      <main className="2xl:w-[75%] m-auto px-10 lg:px-0">
        <section className="2xl:flex">
          <div className="2xl:w-[50%] flex flex-col justify-center">
            <div className=" ">
            ...
            <div className="h-[3px] lg:w-[30%] bg-[#0E86A6] my-5"></div>
          ...
          <div className="2xl:w-[50%] relative">
            <Image
              src={img1}
              alt=""
              objectFit="cover"
              className="rounded-xl 2xl:ml-[113px] h-[500px] 2xl:w-[600px] mt-8 lg:mt-0"
            />
            <div className="absolute inset-0 bg-black opacity-20"></div>
          </div>
        </section>
        {/* Doctors Appoinment */}
        <section className="2xl:flex flex-row-reverse mt-32">
          <div className="2xl:w-[50%] 2xl:ml-[210px] flex flex-col justify-center">
            <div className=" ">
            ...
            <div className="h-[3px] 2xl:w-[30%] my-7   bg-[#0E86A6] lg:my-5"></div>
          ...
          <div className="2xl:w-[50%] relative">
            <Image
              ...
              alt=""
              objectFit="cover"
              className="rounded-xl h-[500px] 2xl:w-[600px] mt-8 lg:mt-0"
            />
