...
import { addLegExercise } from "@/services/exercise";
...
export default function Arms() {
  ...
  // product handle
  async function handleLeg() {
    setComponentLevelLoader({ loading: true, id: "" });

    const res = await addLegExercise(formData);
  ...
  return (
    <div className="w-full  relative pt-[20px]">
      <div className="flex flex-col items-start justify-start p-5 mb-20  rounded-xl relative ">
        <div className="2xl:w-[75%] xl:w-[80%] m-auto space-y-8 shadow-xl px-20 py-10 rounded-lg bg-white relative">
          ...
          <div className="absolute">
            <button
              onClick={handleLeg}
              type="button"
              className="relative text-xl w-[300px] px-8 py-4 ml-4 overflow-hidden font-semibold rounded-lg bg-black text-white left-[330px] top-[-7px]"
            >
              Add New Leg Exercise
            </button>
          </div>
        </div>
      </div>
