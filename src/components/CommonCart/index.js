...
export default function CommonCart({
  ...
  return (
    <section className="max-w-screen bg-gray-100 pt-[100px] lg:pt-[150px]">
      <div className="mx-auto px-4 sm:px-6 lg:px-8 mb-[80px] lg:mb-[150px]">
                ...
                {cartItems && cartItems.length ? (
                  <ul className="-my-8">
                    {cartItems.map((cartItem) => (
                      <li
                        className="flex-col border-b flex space-y-3 py-6 text-left sm:flex-row sm:space-x-5 sm:space-y-0"
                        key={cartItem.id}
                      >
                        <div className="lg:shrink-0 flex justify-center mb-4 mt-2 md:block md:mb-0 md:mt-0">
                          <img
                            src={
                              cartItem &&
                              cartItem.productID &&
