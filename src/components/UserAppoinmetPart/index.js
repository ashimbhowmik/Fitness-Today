  ...
  if (!user?.name) {
    return (
      <div className="lg:pt-[100px] pt-[50px]">
        <div className="relative w-full h-[350px] md:h-[400px] lg:h-[400px] xl:h-[400px] 2xl:h-[550px]">
          <Image
            src={img}
            alt=""
            layout="fill"
  ...
  return (
    <div className="lg:pt-[100px] pt-[50px]">
      {loading ? ( // Conditionally render the loader
        ...
        <>
          <div className="relative h-[300px] md:h-[500px] lg:h-[500px] xl:h-[400px] 2xl:h-[550px]">
            <Image
              src={img}
              alt=""
              layout="fill"
