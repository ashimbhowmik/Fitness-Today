...
export default function AdminAddNewDoctor() {
  ...
  return (
    <div className="w-full pt-[130px]">
      <div className="flex flex-col items-start justify-start p-10 mb-20  rounded-xl ">
        <div className="xl:w-[85%] 2xl:w-[75%] m-auto  shadow-xl  rounded-lg bg-white relative">
          <div className="px-24 pb-14 pt-10 space-y-7">
          ...
          <div className="absolute w-full bottom-[-30px]">
            <div className="flex justify-center">
              <button
                ...
                type="button"
                className="relative text-xl w-[300px] px-8 py-4  overflow-hidden font-semibold rounded-lg bg-black text-white "
              >
                Add New Doctor
              </button>
            </div>
