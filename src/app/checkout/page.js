...
export default function Checkout() {
  ...
  return (
    <div>
      <div className="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32 mb-[100px]  mt-[100px]">
        <div className="px-4 pt-8">
          <p className="font-medium text-xl">Cart Summary</p>
          <div className="flex justify-between lg:block items-center mt-8 lg:space-y-3 rounded-lg border bg-white px-2 py-4 sm:px-5">
